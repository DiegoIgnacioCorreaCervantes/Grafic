...
for t in t_vals:
    ...
    #Sol
    cv2.circle(imagen, (550, 295), radius=60, color=(0, 255, 255), thickness=-1)

    # Generar el punto en la elipse
    punto = generar_punto_elipse(a, b, t)

    punto1 = generar_punto_elipse(a+50, b+50, t)

    punto2 = generar_punto_elipse(a+100, b+100, t)

    punto3 = generar_punto_elipse(a+150, b+150, t)
    
    # Dibujar el punto en la elipse
    cv2.circle(imagen, punto, radius=20, color=(0, 255, 0), thickness=-1)

    cv2.circle(imagen, punto1, radius=15, color=(0, 0, 255), thickness=-1)

    cv2.circle(imagen, punto2, radius=10, color=(150, 255, 255), thickness=-1)

    cv2.circle(imagen, punto3, radius=5, color=(255, 0, 0), thickness=-1)
    ...
    for t_tray in t_vals:
        pt_tray = generar_punto_elipse(a+50, b+50, t_tray)
        cv2.circle(imagen, pt_tray, radius=1, color=(255, 255, 255), thickness=-1)

    for t_tray in t_vals:
        pt_tray = generar_punto_elipse(a+100, b+100, t_tray)
        cv2.circle(imagen, pt_tray, radius=1, color=(255, 255, 255), thickness=-1)

    for t_tray in t_vals:
        pt_tray = generar_punto_elipse(a+150, b+150, t_tray)
        cv2.circle(imagen, pt_tray, radius=1, color=(255, 255, 255), thickness=-1)
